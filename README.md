...
- **AI 대화**: 캐릭터 우클릭 → 말 걸기 (Ctrl+Shift+Space). 사도가 자기 말투로 대답하고 감정에 맞춰 표정·소리를 냅니다. 무료로 쓰려면 [Ollama](https://ollama.com/download)(로컬) 또는 [Google AI Studio](https://aistudio.google.com/apikey) 무료 키, 더 좋은 답을 원하면 Anthropic API 키(유료). 키는 PC에 암호화 저장되고 대화는 선택한 제공자에만 전송됩니다. 가끔 사도가 먼저 말을 걸기도 해요(설정에서 끌 수 있음). 둘 이상 소환하면 사도끼리 다가가 잡담도 합니다
